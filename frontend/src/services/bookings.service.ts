...
export const BookingsService = {
   ...
   */
  async addPlayers(bookingId: number, data: AddPlayersData): Promise<{ success: boolean; message: string; players: Player[] }> {
   ...
   */
  async getBookingPlayers(bookingId: number): Promise<Player[]> {
